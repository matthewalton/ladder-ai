...
- `Ladder/Features/PipelineBoard/src/Stage.swift` — the `Stage.transcript` link (pipeline-board owns
  the Stage model)
- `Ladder/Features/Profile/src/ProfileStore.swift` — the `Transcript.self` schema entry
