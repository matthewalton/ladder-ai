...
- `Ladder/Features/PipelineBoard/src/Stage.swift` — the `Stage.debrief` link (pipeline-board owns the
  Stage model)
- `Ladder/Features/Profile/src/ProfileStore.swift` — the `Debrief.self` / `DebriefQuestion.self`
  schema entries
