...
- `Ladder/PipelineBoard/src/Stage.swift` — the `Stage.prepPack` link (pipeline-board owns the
  Stage model)
- `Ladder/Profile/src/ProfileStore.swift` — the `PrepPack.self` / `PrepTalkingPoint.self`
  schema entries
